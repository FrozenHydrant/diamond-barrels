...
public class TileEntityIronBarrel extends TileEntityLockableLoot implements ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.iron_barrel";
	}
	...
	{
		return new ContainerIronBarrel(playerInventory, this, playerIn);
	}
	
	@Override
	public String getGuiID() 
	{
		return DiamondBarrels.MODID + ":iron_barrel";
	}
