...
public class TileEntityDiamondBarrel extends TileEntityLockableLoot implements ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.diamond_barrel";
	}
	...
	{
		return new ContainerDiamondBarrel(playerInventory, this, playerIn);
	}
