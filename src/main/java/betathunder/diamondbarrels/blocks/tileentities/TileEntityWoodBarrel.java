...
public class TileEntityWoodBarrel extends TileEntityLockableLoot implements ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.wood_barrel";
	}
	...
	{
		return new ContainerWoodBarrel(playerInventory, this, playerIn);
	}
	
	@Override
	public String getGuiID() 
	{
		return DiamondBarrels.MODID + ":wood_barrel";
	}
