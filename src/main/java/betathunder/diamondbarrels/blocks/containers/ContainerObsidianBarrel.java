...
public class ContainerObsidianBarrel extends Container
{
	private final int numRows;
	private final int numCols = 12;
	private final TileEntityObsidianBarrel chestInventory;
	
	public ContainerObsidianBarrel(InventoryPlayer playerInv, TileEntityObsidianBarrel tileEntityObsidianBarrel, EntityPlayer player) 
	{
		this.chestInventory = tileEntityObsidianBarrel;
		this.numRows = tileEntityObsidianBarrel.getSizeInventory() / numCols;
		tileEntityObsidianBarrel.openInventory(player);
		...
		for(int i = 0; i < this.numRows; ++i)
		{
			...
			{
				this.addSlotToContainer(new Slot(tileEntityObsidianBarrel, j + i*numCols, 12 + j*18, 8 + i*18));
			}
		}
	...
	public TileEntityObsidianBarrel getChestInventory()
	{
