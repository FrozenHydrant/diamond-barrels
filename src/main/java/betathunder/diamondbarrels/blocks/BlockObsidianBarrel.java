...
public class BlockObsidianBarrel extends BlockContainer implements IHasModel {
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockObsidianBarrel(String name) {
		super(Material.ROCK);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (!worldIn.isRemote) {
			playerIn.openGui(DiamondBarrels.instance, DiamondBarrels.GUI_OBSIDIAN_BARREL, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		TileEntityObsidianBarrel tileentity = (TileEntityObsidianBarrel) worldIn.getTileEntity(pos);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
		...
		if (stack.hasDisplayName()) {
			...
			if (tileentity instanceof TileEntityObsidianBarrel) {
				((TileEntityObsidianBarrel) tileentity).setCustomName(stack.getDisplayName());
			}
		}
	}
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityObsidianBarrel();
	}
