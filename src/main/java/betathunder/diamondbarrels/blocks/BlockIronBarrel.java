...
public class BlockIronBarrel extends BlockContainer implements IHasModel {
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockIronBarrel(String name) {
		super(Material.ROCK);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (!worldIn.isRemote) {
			playerIn.openGui(DiamondBarrels.instance, DiamondBarrels.GUI_IRON_BARREL, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		TileEntityIronBarrel tileentity = (TileEntityIronBarrel) worldIn.getTileEntity(pos);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
		...
		if (stack.hasDisplayName()) {
			...
			if (tileentity instanceof TileEntityIronBarrel) {
				((TileEntityIronBarrel) tileentity).setCustomName(stack.getDisplayName());
			}
		}
	}
